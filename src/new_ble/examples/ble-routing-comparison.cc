...
NS_LOG_COMPONENT_DEFINE ("BleRoutingAodv");
  ...
  int duration = 100; //<! Duration of the simulation in seconds
  ...
  for (uint8_t iterationI=0;iterationI<nbIterations;iterationI++){
    ...
    if (printRoutes)
    {
      Ptr<OutputStreamWrapper> routingStream = 
        Create<OutputStreamWrapper> ("aodv2.routes", std::ios::out);
      aodv.PrintRoutingTableAllAt (Seconds (2), routingStream);
      Ptr<OutputStreamWrapper> routingStream2 = 
        Create<OutputStreamWrapper> ("aodv3.routes", std::ios::out);
      aodv.PrintRoutingTableAllAt (Seconds (3), routingStream2);
      Ptr<OutputStreamWrapper> routingStream3 = 
        Create<OutputStreamWrapper> ("aodv4.routes", std::ios::out);
      aodv.PrintRoutingTableAllAt (Seconds (4), routingStream3);
      Ptr<OutputStreamWrapper> routingStream4 = 
        Create<OutputStreamWrapper> ("aodv6.routes", std::ios::out);
      aodv.PrintRoutingTableAllAt (Seconds (6), routingStream4);
      Ptr<OutputStreamWrapper> routingStream5 = 
        Create<OutputStreamWrapper> ("aodv10.routes", std::ios::out);
      aodv.PrintRoutingTableAllAt (Seconds (10), routingStream5);
      Ptr<OutputStreamWrapper> routingStream6 = 
        Create<OutputStreamWrapper> ("aodv13.routes", std::ios::out);
      aodv.PrintRoutingTableAllAt (Seconds (13), routingStream6);
      Ptr<OutputStreamWrapper> routingStream7 = 
        Create<OutputStreamWrapper> ("aodv14.routes", std::ios::out);
      aodv.PrintRoutingTableAllAt (Seconds (14), routingStream7);
      Ptr<OutputStreamWrapper> routingStream8 = 
        Create<OutputStreamWrapper> ("aodv15.routes", std::ios::out);
      aodv.PrintRoutingTableAllAt (Seconds (15), routingStream8);
      Ptr<OutputStreamWrapper> routingStream9 = 
        Create<OutputStreamWrapper> ("aodv16.routes", std::ios::out);
      aodv.PrintRoutingTableAllAt (Seconds (16), routingStream9);
      ...
      Ptr<OutputStreamWrapper> routingStream11 = 
        Create<OutputStreamWrapper> ("aodv40.routes", std::ios::out);
      aodv.PrintRoutingTableAllAt (Seconds (40), routingStream11);
      Ptr<OutputStreamWrapper> routingStream12 = 
        Create<OutputStreamWrapper> ("aodv60.routes", std::ios::out);
      aodv.PrintRoutingTableAllAt (Seconds (60), routingStream12);
      Ptr<OutputStreamWrapper> routingStream13 = 
        Create<OutputStreamWrapper> ("aodv66.routes", std::ios::out);
      aodv.PrintRoutingTableAllAt (Seconds (66), routingStream13);
    }
